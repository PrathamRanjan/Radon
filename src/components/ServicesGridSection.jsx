...
export const ServicesGridSection = () => {
  const services = [
    {
      title: "Chatbots and AI Avatars",
      description: "Custom AI Chatbots with RAG, and web searching capabilities built on the latest fine-tuned language models, and intelligent automation systems.",
      icon: (
