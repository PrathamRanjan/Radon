...
export function AnimatedBeamDemo() {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-900 flex items-center justify-center py-20 relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="text-center max-w-4xl mx-auto px-4 relative z-10">
        <h2 className="text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
          We find the synergy between Tech and Your Business
        </h2>
        <p className="text-gray-400 text-base md:text-lg mb-8 md:mb-16 max-w-2xl mx-auto">
          With a vast skillset, we are able to build solutions that are tailored to your needs, whether you are a small business or a large enterprise.
        </p>
